...
- [Export to Google Drive](skills/export-to-google-drive/SKILL.md): organize
  generated deliverables under `Projects/<project>` with consistent names and
  duplicate-aware revision handling.
